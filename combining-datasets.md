...
These are some nice examples of combining datasets in visualizations. There were a lot of COVID-related examples, so I've split them along those lines.
...
### Hours of Work Needed to Purchase a Week's Worth of Groceries

<img src="imgs/hours-groceries.png" height="400"/>

This chart was posted on X by the [White House Council of Economic Advisors in Sep 2024](https://x.com/WHCEA46Archive/status/1833855060209488306).

Data combinations:
* Nominal groceries expenditures for non-managers in 2022, likely from <https://www.bls.gov/opub/reports/consumer-expenditures/2022/>
* CPI: food at home (used to adjust nominal groceries expenditures), likely from <https://www.bls.gov/opub/ted/2022/prices-for-food-at-home-up-13-5-percent-for-year-ended-august-2022.htm>
* Average hourly earnings for production/nonsupervisory workers, likely from <https://www.bls.gov/ces/data/employment-and-earnings/2022/table8b_202202.htm>

This is a nice illustration of deriving the data into something that is easy for people to understand. It shows the relationship between grocery prices and hourly wages over time by transforming wages into purchasing power.
